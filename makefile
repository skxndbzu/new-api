...
.PHONY: all build-web build-web-classic build-docs build-all-web start-api dev dev-api dev-api-rebuild dev-web dev-web-classic reset-setup
...
build-all-web: build-web build-web-classic build-docs
