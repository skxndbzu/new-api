...
export const channelFormSchema = z
  .object({
    ...
    image_generation_stream_enabled: z.boolean().optional(),
...
export const CHANNEL_FORM_DEFAULT_VALUES: ChannelFormValues = {
  ...
  image_generation_stream_enabled: false,
  system_prompt: '',
    ...
    try {
      ...
      extraSettings = {
        ...
        image_generation_stream_enabled:
          parsed.image_generation_stream_enabled === true,
...
export function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj: Record<string, unknown> = {
    ...
    image_generation_stream_enabled:
      formData.image_generation_stream_enabled || false,
