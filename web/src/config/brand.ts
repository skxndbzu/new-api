...
export const BRAND_CONFIG = {
  ...
  sloganKey: 'Unified access, multi-model aggregation, flexible distribution',
...
export function resolveBrandLogoPath(logo?: string | null): string {
...
export function resolveBrandDocsPath(docsUrl?: string | null): string {
